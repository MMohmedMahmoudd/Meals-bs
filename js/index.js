...
function displayMeals(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
        <div class="col-md-3">
            <div class="meal position-relative overflow-hidden rounded-2 cursor-pointer" data-meal-id="${arr[i].idMeal}">
...
function displayArea(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
        <div class="col-md-3">
            <div class="rounded-2 text-center cursor-pointer" data-area="${arr[i].strArea}">
                <i class="fa-solid fa-house-laptop fa-4x"></i>
                <h3>${arr[i].strArea}</h3>
            </div>
        </div>`;
...
function displayIngredients(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
        <div class="col-md-3">
            <div class="rounded-2 text-center cursor-pointer" data-ingredient="${arr[i].strIngredient}">
                <i class="fa-solid fa-drumstick-bite fa-4x"></i>
                <h3>${arr[i].strIngredient}</h3>
                <p>${arr[i].strDescription.split(" ").slice(0, 20).join(" ")}</p>
            </div>
    ...
    rowData.innerHTML = cartoona;
    $("[data-ingredient]").on("click", function() {
...
function showSearchInputs() {
    ...
    <div class="row py-4">
        ...
        <div class="col-md-6">
            <input id="searchByLetter" class="form-control bg-transparent text-white" type="text" placeholder="Search By First Letter" maxlength="1">
        </div>
    </div>`;
    rowData.innerHTML = "";
